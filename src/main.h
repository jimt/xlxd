...
#define YSF_DEFAULT_NODE_TX_FREQ        430710000                           // in Hz
#define YSF_DEFAULT_NODE_RX_FREQ        430710000                           // in Hz
#define YSF_AUTOLINK_ENABLE             1                                   // 1 = enable, 0 = disable auto-link
#define YSF_AUTOLINK_MODULE             'K'                                 // module for client to auto-link to
